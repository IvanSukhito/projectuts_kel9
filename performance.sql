...
--
-- Host: 127.0.0.1    Database: karyawan_kelompok9
-- ------------------------------------------------------
...
CREATE TABLE `performance` (
  ...
  PRIMARY KEY (`nik`)
) ENGINE=InnoDB AUTO_INCREMENT=352000004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Dump completed on 2023-10-21 17:12:29
